...
{block name="content"}
                ...
                {if \Lib\User\User::can('view_patient_phi', $userPermissions)}
                    <legend>User Information</legend>
                        ...
                        <div class="row">
                            ...
                            <div id="confirm-email-holder" class="col-md-6 form-group" style="visibility: hidden;">
                                <div class="col-md-4">
    ...
    {* {if !empty($user->practice_id)} *}
        <div class="block">
            ...
            <div class="col-md-6">
                <button id="create-followup" class="btn btn-primary col-md-12 center" data-toggle="modal" data-target="#followupNewModal">Create New Follow Up</button>
            </div>
        </div>
    {* {/if} *}
        <div class="block">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {if \Lib\User\User::can('view_patient_phi', $userPermissions)}
                                                ...
                                                {else}
                                                    <button class="pure-button login-user btn btn-primary" data-user_id="{$patient->user_id}" data-redirect-url="/actionplan?action_plan_id={$value.batch_id}">Copy Plan</button>
                                                {/if}
                                            {/if}
                                        </td>
                                    </tr>
